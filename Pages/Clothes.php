...
<div>
    ...
    <div class ="rowss">
    <?php
    $clothesProducts = new MenuController;
    $allClothesProducts = $clothesProducts->readClothProducts();
    foreach($allClothesProducts as $clothesProducts) {
        echo ' 
        <div class="rows">
            <div class="row1">
                <div class = "square1">
                <div class="imagess">
                <img src="' .$clothesProducts['menu_image'].'">
                </div>

                <a href="./product-desc.php?id='.$clothesProducts['id'].'">
                <div class="buy-now">
                ...
                <div class="name">'. $clothesProducts['menu_name'].'</div>
                </div>
