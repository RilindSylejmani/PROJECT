...
<div>
    ...
    <div class ="rowss">
    <?php
    $accessoryProducts = new MenuController;
    $allAccessoryProducts = $accessoryProducts->readAccessoryProducts();
    foreach($allAccessoryProducts as $accessoryProducts) {
        echo ' 
        <div class="rows">
            <div class="row1">
                <div class = "square1">
                <div class="imagess">
                <img src="' .$accessoryProducts['menu_image'].'">
                </div>

                <a href="./product-desc.php?id='.$accessoryProducts['id'].'">
                <div class="buy-now">
                ...
                <div class="name">'. $accessoryProducts['menu_name'].'</div>
                </div>
