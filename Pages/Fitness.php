...
<div>
    ...
    <div class ="rowss">
    <?php
    $fitnessProducts = new MenuController;
    $allFitnessProducts = $fitnessProducts->readFitnessProducts();
    foreach($allFitnessProducts as $fitnessProducts) {
        echo ' 
        <div class="rows">
            <div class="row1">
                <div class = "square1">
                <div class="imagess">
                <img src="' .$fitnessProducts['menu_image'].'">
                </div>

                <a href="./product-desc.php?id='.$fitnessProducts['id'].'">
                <div class="buy-now">
                ...
                <div class="name">'. $fitnessProducts['menu_name'].'</div>
                </div>
