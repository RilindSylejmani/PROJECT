...
<div>
    ...
    <div class ="rowss">
    <?php
    $technologyProducts = new MenuController;
    $allTechnologyProducts = $technologyProducts->readTechProducts();
    foreach($allTechnologyProducts as $technologyProducts) {
        echo ' 
        <div class="rows">
            <div class="row1">
                <div class = "square1">
                <div class="imagess">
                <img src="' .$technologyProducts['menu_image'].'">
                </div>
                <a href="./product-desc.php?id='.$technologyProducts['id'].'">
                <div class="buy-now">
                ...
                <div class="name">'. $technologyProducts['menu_name'].'</div>
                </div>
